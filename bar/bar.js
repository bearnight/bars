var maxZ = 1;
var barType="../images/bar/PurpleBar/";
function closebg()
{
...
function showFacebook()
{
	...
	toShow1.children[0].children[0].src = toShow1.children[0].children[0].src;
	var toShow2 = document.getElementById('fb2');
	toShow2.children[0].children[0].src = toShow2.children[0].children[0].src;
	var toShow3 = document.getElementById('fb3');
	toShow3.children[0].children[0].src = toShow3.children[0].children[0].src;
    if (toShow1.style.visibility == "hidden")
	{
		  maxZ = maxZ + 1;
		  toShow1.style.zIndex = maxZ;
		  toShow2.style.zIndex = maxZ;
		  toShow3.style.zIndex = maxZ;
